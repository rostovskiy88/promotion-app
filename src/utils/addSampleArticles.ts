...
const sampleArticles = [
  ...
  },
  {
    ...
    content:
      'Here are 11 things I wish I knew when I started my business. I hope they will save you some time and some anguish because experience is a good teacher, but it can also be an expensive one. From understanding cash flow management to building the right team, avoiding common legal pitfalls, and creating sustainable business processes, these lessons learned the hard way will help you navigate the entrepreneurial journey more successfully.',
    category: 'Business',
    authorId: 'COb1QiaSKjf3IIc2u43tc6mPF8t2',
  ...
  },
  {
    ...
    content:
      'Time management is crucial for developers who juggle multiple projects and deadlines. Here are proven strategies to boost your productivity and maintain work-life balance.',
    category: 'Productivity',
    authorId: 'COb1QiaSKjf3IIc2u43tc6mPF8t2',
  ...
  },
  {
    ...
    content:
      "In today's digital world, having a strong personal brand on social media is essential for career growth. Learn how to create authentic content that resonates with your audience.",
    category: 'Media',
    authorId: 'COb1QiaSKjf3IIc2u43tc6mPF8t2',
  ...
  },
  {
    ...
    content:
      'Raising funds for your startup can be challenging. This comprehensive guide covers everything from seed funding to Series A and beyond, with real-world examples and tips.',
    category: 'Business',
    authorId: 'COb1QiaSKjf3IIc2u43tc6mPF8t2',
  ...
  },
  {
    ...
    content:
      'Remote work has transformed the modern workplace. Explore the trends, challenges, and opportunities that lie ahead for distributed teams and digital nomads.',
    category: 'Business',
    authorId: 'COb1QiaSKjf3IIc2u43tc6mPF8t2',
  ...
  },
  {
    ...
    content:
      'Understanding the differences between CSS Grid and Flexbox is crucial for modern web development. Learn when to use each layout method for optimal results.',
    category: 'Productivity',
    authorId: 'COb1QiaSKjf3IIc2u43tc6mPF8t2',
  ...
  },
  {
    ...
    content:
      'Cut through the noise with content marketing strategies that deliver real results. From storytelling to SEO optimization, master the art of engaging your audience.',
    category: 'Media',
    authorId: 'COb1QiaSKjf3IIc2u43tc6mPF8t2',
  ...
  },
  {
    ...
    content:
      'Learn from successful Silicon Valley entrepreneurs about the key strategies for scaling your startup from 10 to 10,000 employees while maintaining culture and quality.',
    category: 'Business',
    authorId: 'COb1QiaSKjf3IIc2u43tc6mPF8t2',
  ...
  },
  {
    ...
    content:
      'Boost your JavaScript application performance with these proven optimization techniques. From memory management to async patterns, improve your code efficiency and user experience. Learn about bundle optimization, lazy loading strategies, caching mechanisms, debugging performance bottlenecks, implementing efficient algorithms, and leveraging modern JavaScript features to create lightning-fast web applications that scale gracefully.',
    category: 'Productivity',
    authorId: 'COb1QiaSKjf3IIc2u43tc6mPF8t2',
  ...
  },
  {
    ...
    content:
      'Effective code reviews are essential for maintaining code quality and team collaboration. Learn best practices for giving and receiving constructive feedback.',
    category: 'Productivity',
    authorId: 'COb1QiaSKjf3IIc2u43tc6mPF8t2',
