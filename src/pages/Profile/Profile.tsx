      ...
      <Col>
        ...
        >
          ...
          <Tabs activeKey={activeTab} onChange={setActiveTab} style={{ marginBottom: 24 }}>
            <TabPane tab={<span style={{ fontWeight: activeTab === '1' ? 500 : 400, color: activeTab === '1' ? '#1557ff' : '#b0b4ba' }}>Edit Information</span>} key="1" />
            <TabPane tab={<span style={{ color: '#b0b4ba' }}>User Avatar</span>} key="2" disabled />
            <TabPane tab={<span style={{ fontWeight: activeTab === '3' ? 500 : 400, color: activeTab === '3' ? '#1557ff' : '#b0b4ba' }}>Change Password</span>} key="3" />
          </Tabs>
          {activeTab === '1' && (
            <>
